...
if __name__ == "__main__":
    ...
    df_Test_copy2[a_cluster_attribute_finder].fillna(-1).astype(int)

    print(df_Training_copy2[a_cluster_attribute_finder][0])

    print(df_Test_copy2[a_cluster_attribute_finder][0])
    ...
    naiveClusterSix = naiveClassSix.calc_naive_estimate(clustersTraining[5], clustersTest[5], a_file_finish_finder, trainingAddress)

    naiveClassSeven = NaiveModel()
    naiveClusterSeven = naiveClassSeven.calc_naive_estimate(clustersTraining[6], clustersTest[6], a_file_finish_finder, trainingAddress)

    naiveClassEight = NaiveModel()
    naiveClusterEight = naiveClassEight.calc_naive_estimate(clustersTraining[7], clustersTest[7], a_file_finish_finder, trainingAddress)

    naiveClassNine = NaiveModel()
    naiveClusterNine = naiveClassNine.calc_naive_estimate(clustersTraining[8], clustersTest[8], a_file_finish_finder, trainingAddress)

    naiveClassTen = NaiveModel()
    naiveClusterTen = naiveClassTen.calc_naive_estimate(clustersTraining[9], clustersTest[9], a_file_finish_finder, trainingAddress)
    '''
    ...
    print("6 ", len(naiveClusterSix))
    print("7 ", len(naiveClusterSeven))
    print("8 ", len(naiveClusterEight))
    print("9 ", len(naiveClusterNine))
    print("10 ", len(naiveClusterTen))
    '''
