class FileFinishFinder:
    ...
    def determine_FinishEvents(self, trainingAddress):
        if "dummy" in trainingAddress:
        ...
        elif "BPI_Challenge_2012" in trainingAddress:
            ...
            self.data_file_name = "BPI_Challenge_2012"
            ...
            self.data_file_name = "BPI_Challenge_2019"
